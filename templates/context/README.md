...
Read this index before non-trivial work in a repository. Select the nearest
project-owned context payload that matches the task, then stop loading context
once the route is sufficient.
