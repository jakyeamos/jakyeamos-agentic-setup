#!/usr/bin/env python3
"""Pure validation and planning contracts for JAS promotion admission."""
...
from scripts.catalog_validation import _validate_asset, load_manifest  # noqa: E402
...
def _public_overlay(
    ...
    """Build the v1 overlay used for a combined public admission."""
