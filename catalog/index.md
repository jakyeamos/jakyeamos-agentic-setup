...
| [`project-compass`](../skills/project-compass/SKILL.md) | Reconcile changing product truth across root and subsystem compasses with intent-first onboarding, realignment quizzes, and honest MVP and complete-product progress. | `change-surface-routing`, `checkpointing`, `conversation-continuity`, `cross-compass-alignment`, `onboarding-quiz`, `product-direction`, `progress`, `realignment-quiz`, `reorientation`, `scope-drift`, `scoped-compasses` | experimental | copy |
